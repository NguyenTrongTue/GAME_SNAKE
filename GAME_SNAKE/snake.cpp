...
Snake::Snake()
{
    ...
    SDL_SetWindowPosition(window, 100, 20);
    ...
    segmentsList.push_back(std::make_pair(4, 5));//5 5
    segmentsList.push_back(std::make_pair(4, 6));//5 6
    segmentsList.push_back(std::make_pair(4, 6));//4 6
